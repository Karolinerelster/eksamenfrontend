        ...
        <section id="modal-basket" className={ props.basketDisplay ? "" : "slide-hidden"}>
            <div className="basket-inner">
                ...
                <div className="basket-items">
                    {basketItems === 0 && <><h3>Not thirsty? Currently no items in basket</h3><hr /></>}
                    {mappedBeers}
                </div>
                ...
                <div className="basket-checkout">
                    ...
                    <button onClick={togglePaymentModal} className={totalPrice === 0 ? "proceed-locked" : ""} >I know You're thirsty! Proceed</button>
                </div>
            </div>
